...
public  class LoginRiderPresenter implements LoginRiderContract.Presenter {


    private LoginRiderContract.View mView ;
    private WindowManager mWindowManager=null;
    private WindowManager.LayoutParams wmParams =null;
    private RelativeLayout welcome8WindowLayout =null;
    private ProgressBar progressBar;

    public LoginRiderPresenter(LoginRiderContract.View view) {
        this.mView = view;
